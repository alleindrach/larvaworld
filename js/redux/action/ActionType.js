...
export const WORK_SCENE_SELECT='work/scene/select'
export const WORK_SCENE_INIT='work/scene/init'
export const WORK_SYNC='work/sync'
export const WORK_SYNC_UPLOADING='work/sync/uploading'
export const WORK_SYNC_UPLOAD_SUCCESS='work/sync/upload/success'
export const WORK_SYNC_MERGED='work/sync/merged'
